...
uint256 hashGenesisBlock("0x778592ed746fad2fce781ef9e2ef6a4dcd2749c21b57d33178cd1243b794b3ab");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 500); // Oryxcoin: 500 blocks in ~0.01 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Oryxcoin: 3 days retarget redifficulty
static const int64 nTargetSpacing = 5 * 60; // Oryxcoin: 5 minutes block time
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x778592ed746fad2fce781ef9e2ef6a4dcd2749c21b57d33178cd1243b794b3ab");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Oryxcoin : the next big thing after bitcoin (starts now)";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x19a5970661e75fc4e7696e8558c0829073815562a93fe2d934b4a0da983fba15"));
